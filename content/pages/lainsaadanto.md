...
Suomen ympäristökeskus (Syke), kunnat ja maakuntien liitot määrätään alueidenkäytön tietovarannon yhteisrekisterinpitäjiksi ([RYTJ-laki](https://www.finlex.fi/fi/lainsaadanto/2023/431) 4 §):
...
[RYTJ-lain](https://www.finlex.fi/fi/lainsaadanto/2023/431) 5 pykälässä määrätään kuntien ja maakuntien liittojen velvoitteesta toimittaa kaavatietoa Rakennetun ympäristön tietojärjestelmään seuraavasti:
...
## Nykyisten säädösten kattavuus yhteentoimivuuden näkökulmasta

Yhteenvetona voidaan sanoa, että alueidenkäyttölaki sellaisenaan velvoittaa kuntia ja maakuntien liittoja kaavatiedon tuottajia yhteentoimivuuden näkökulmasta vain hyvin yleisellä tasolla: kaavatiedon tulee laatia (jossain) tietomallimuodossa, joka on valtakunnallisesti yhteentoimiva. Katja-asetuksessa määrätään käyttämään liitteiden 1-3 "kaavamääräyskoodeja" maakunta-, yleis- ja asemakaavoissa ilman että kerrotaan missä yhteydessä ja miten niitä tulisi käyttää käyttää. 

Ympäristöministeriön tietoinen päätös on ollut (ainakin toistaiseksi) välttää kaavatietomallin tekniseen toteutukseen ja käyttötapaan liittyvää teknistä ohjeistusta laki- ja asetustasolla, ja jättää se ei-velvoittavan ohjeistuksen varaan (ks. [soveltamisohjeet](/?page=soveltamisohjeet)). Lainsäädännössä ei määrätä mitään tiedonsiirtotavoista ja -formaateista tietomallimuotoisen kaavatiedon siirtämiseksi eri tietojärjestelmien välillä sen paremmin Ryhti-järjestelmän ja kaavatiedon tuottajien kuin kuntien ja maakuntien liittojen tietojärjestelmien välillä.