...
export const fi: Translations = {
  ...
  dataModel: {
    ...
    status: 'Tila',
    modified: 'Muokattu',
    openSuomiFiModel: 'Avaa Tietomallit.suomi.fi',
    ...
    classesOptGroup: 'Sisältyvät luokat (Classes)',
    codelistsOptGroup: 'Käytetyt koodistot (Codelists)',
    classLabel: 'Luokka',
    codelistLabel: 'Koodisto',
    technicalName: 'Tekninen nimi:',
    uri: 'URI:',
    classDiagram: 'Luokkakaavio (Mermaid Class Diagram)',
    ...
    updated: 'Päivitetty:',
    openCodelistService: 'Avaa Koodistopalvelu',
    codesTitle: 'Koodit',
    ...
    showDocumentation: 'Näytä dokumentaatio ja muutoshistoria',
    hideDocumentation: 'Piilota dokumentaatio ja muutoshistoria',
  },
};
