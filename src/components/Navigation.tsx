...
interface HeaderProps {
  ...
  onNavigatePlans?: (slug: string | null) => void;
  onHome: () => void;
  onBlog: () => void;
  onSearchNavigate: (type: string, slug: string) => void;
}

export function Header({ onNavigatePage, onNavigateTag, onNavigatePost, onNavigateAuthor, onNavigateModel, onNavigateValidate, onNavigatePlans, onHome, onBlog, onSearchNavigate }: HeaderProps) {
